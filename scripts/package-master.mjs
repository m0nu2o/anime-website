#!/usr/bin/env node
/**
 * Master Production ZIP packaging for NextGen Anime platform.
 *
 * Creates `nextgen-anime-master-final.zip` at the project root while strictly preserving
 * existing baseline archives (nextgen-anime-final.zip, nextgen-anime-ultra-final.zip) and excluding:
...
const OUTPUT = join(ROOT, "nextgen-anime-master-final.zip");
