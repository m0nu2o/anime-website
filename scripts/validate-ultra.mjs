...
const zip = new AdmZip(path.join(ROOT, "nextgen-anime-ultra-final.zip"));
...
console.log("Total entries in ultra-final ZIP:", entries.length);
...
// Check critical application components exist in the ZIP
const criticalFiles = [
  "src/app/page.tsx",
